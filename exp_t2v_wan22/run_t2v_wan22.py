"""
run_t2v_wan22.py — GVCC T2V on Wan 2.2-A14B (MoE) Unconditional Compression Experiment
...
from sde_rf_wan.wan22_t2v_wrapper import WanT2VA14BDiffusersWrapper
...
def main():
    ...
    # Load model
    # ================================================================
    model = WanT2VA14BDiffusersWrapper(args.wan_ckpt, flow_shift=args.flow_shift)
