"""
run_t2v_5b.py — GVCC T2V on Wan 2.2-TI2V-5B (non-MoE) Unconditional Compression Experiment
...
from sde_rf_wan.wan22_ti2v_5b_wrapper import WanTI2V5BDiffusersWrapper
...
def main():
    ...
    # Load model
    # ================================================================
    model = WanTI2V5BDiffusersWrapper(args.wan_ckpt, flow_shift=args.flow_shift)
